  ...
  <div class="col">
    <div class="e-tabs mb-3 mt-5 px-3">
      <ul class="nav nav-tabs">
        <li class="nav-item"><a class="nav-link" href="/ELJADI_Mohammed_biblio/emprunt/listEmprunt.jsp">Liste des emprunts en cours</a></li>
        <li class="nav-item"><a class="nav-link active" href="/ELJADI_Mohammed_biblio/emprunt/listEmprunt2.jsp">Liste des emprunts remis</a></li>
      </ul>
    </div>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
						...
						<td class="text-nowrap align-middle"><%=emprunt.getRemis_le()%></td>
